# -*- coding: utf-8 -*-
"""
PARTE 2 do pipeline de recomendação de matrícula.
...
# -------------------------------------------------------------
# CONSTANTES DE CALIBRAÇÃO  (knobs — ver nota de calibração no fim do arquivo)
# -------------------------------------------------------------
...
def esta_disponivel(node, disciplinas_resolvidas):
    """True se ao menos um grupo de pré-requisitos está satisfeito (OR de grupos AND)."""
